...
export default function Suits() {
    return (
        <section className="suits-section" id="suits">
            <div className="suits-banner">
                <p>Welcome to classic motel suits</p>
            ...
            <div className="container">
                <div className="suits-grid">
                    <div className="suits">
                        <div className="suits-img">
                            <img src={Simgtwo} alt="suits" />
                            <div className="suits-img-price">
                                <p>$400/Niight</p>
                            </div>
                            <div className="suits-img-overlay"></div>
                            <div className="suits-detail">
                                <h3>Meadow Chalet</h3>
                                <p>120 m² / Great Mountain View / 6 Guests</p>
                                <div className="suits-sub-detail">
                                    <div className="suits-svg">
                                        <svg
                                            id="Layer_1"
                                            data-name="Layer 1"
                            ...
                            <div className="suits-green-layler"></div>
                            <div className="suits-hover-detail">
                                <p>
                                    The dark wood panelling and furnishings,
                                    red-draped fourposter bed, and black stone
                                    bathroom evoke the charm of a secluded
                                    Sierra Nevada.
                                </p>
